...
reverse:
    ...
    mov rdi, reversed         ; начало перевернутой строки
    add rsi, rcx              ; перемещаемся в конец исходной строки
    sub rsi, 2                ; последний символ (не перевод строки)
    ...
    mov byte [rdi], 10        ; добавление в конец перевода строки
    mov byte [rdi+1], 0       ; добавление в конец нуль-терминатора
